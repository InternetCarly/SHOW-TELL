...
Push `index.html` and `send.html` to a GitHub Pages repo, or just open them directly from your file system for testing.
...
index.html?server=wss://utriculate-lilith-isorhythmic.ngrok-free.dev&room=myevent
```
